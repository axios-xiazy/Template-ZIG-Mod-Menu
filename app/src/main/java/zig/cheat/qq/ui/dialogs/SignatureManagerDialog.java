...
public class SignatureManagerDialog {
    ...
    private void doDisable() {
        ...
        executor.execute(() -> {
            try {
                boolean success = Jni.disableBypass();
                handler.post(() -> {
                    if (success) {
    ...
    private void doVerify() {
        ...
        executor.execute(() -> {
            try {
                String jniResult = Jni.verifySignatureStatus();
